...
public class PageToolsController extends SuperController {
	...
	// LoggerFactory.getLogger(PageToolsController.class);
	...
	public void getVerificationCode(String str, HttpServletRequest request, HttpServletResponse response)
	...
	public void getNewAreaCode(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void getNewShopCode(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void checkLoginNameUniqueness(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void getToolTipMsgById(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
		JSONObject json = new JSONObject();
	...
	public void getExpressServiceProviderInfo(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void getExpressStatisticalArea(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		SystemUser sysUser = getSystemUser(request, response);
		PrintWriter printWriter = null;
		Map<String, Object> params = new HashMap<String, Object>();
		if (sysUser != null) {
			params.put("areaCode", sysUser.getAreaCode());
	...
	@ResponseBody
	@RequestMapping("/pages/system/getExpressStatisticalAreaSpe.light")
	public void getExpressStatisticalAreaSpe(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		SystemUser sysUser = getSystemUser(request, response);
		PrintWriter printWriter = null;
		Map<String, Object> params = new HashMap<String, Object>();
		if (sysUser != null) {
			params.put("areaCode", sysUser.getAreaCode());
			params.put("shopCode", sysUser.getServiceShopCode());
			params.put("loginName", sysUser.getLoginName());
		}
		JSONArray jsonArray = systemServiceInterface.getExpressStatisticalAreaSpe(params);
		try {
			response.setCharacterEncoding("utf-8");
			response.setContentType("text/html; charset=utf-8");
			printWriter = response.getWriter();
	...
	public void getShopNumberOfPeopleGroupCount(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
	...
	public void getShopInAndSendExpressGroupCount(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
		String type = request.getParameter("type");
		String code = request.getParameter("code");
	...
	public void getShopOutAndSendExpressGroupCount(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
	...
	public void getSendOutExpressByExpressGroup(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
		String shopCode = request.getParameter("shopCode");
		String limitTime = request.getParameter("limitTime");
	...
	public void initExpressServiceProviders(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
		SystemUser s = getSystemUser(request, response);
		String areaCode = null;
	...
	public void initCancelSignatureTag(String str, HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
		SystemUser s = getSystemUser(request, response);
	...
	public void getCustomeInfoList(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		PrintWriter printWriter = null;
		SystemUser s = getSystemUser(request, response);
		try {
	...
	public void getTemporaryStorage(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void getOutStorehouseBatchNumber(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void getSignatureByBatchNumber(HttpServletRequest request, HttpServletResponse response, String batchNumber,
	...
	public void downExpressInfoByFilterConditions(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		SystemUser s = getSystemUser(request, response);
	...
	public void downShopInAndSendGroupCount(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void downOutAndSendExpressGroupCount(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public void downShopOutAndSendExpressGroup(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		String shopCode = request.getParameter("down_shop_code");
		String paramDate = request.getParameter("down_paramDate");
		String shopName = request.getParameter("down_shopName");
	...
	public void downShopCustomerCount(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException {
		String type = request.getParameter("down_type");
		String code = request.getParameter("down_code");
		JSONArray jsonArray = systemServiceInterface.getShopNumberOfPeopleGroupCount(type, code);
